...
////// Emissive:
                ...
                float3 node_7016 = (((_MainCol_var.rgb*saturate(dot(lightDirection,i.normalDir)))+pow((saturate(dot(lightDirection,viewReflectDirection))*_SpecCol_var.rgb),_SpecPow_var))*attenuation);
                ...
                float3 node_8144 = (_AOTex_var.rgb*(((node_138*_EnvTopCol_var.rgb)+((1.0-(node_138+node_6737))*_EnvMiddleCol_var.rgb)+(node_6737*_EnvBottomCol_var.rgb))*_EnvRatio_var));
                float3 emissive = (node_7016+node_8144);
